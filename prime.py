...
def main():
    ...
    for x in xrange(1,1001,2):
        ...
        turtles[count].color("#FF%d%d" %(30+5*count, 10+5*count), "#FF%d%d" %(30+5*count, 10+5*count))
        ...
        if count > 9:
            count = 0
            print # making new row at the end of the 10th column in text output

    # Turtle captions - Column indexes
    for x in xrange(0,10):
        turtles[x].color("#FFFFFF", "#FF3333")
        turtles[x].write("%d" %(x), True, align="right", font = ("Arial", 16, "bold"))

    # Render user interface
    turtle.penup()
    turtle.color("#FFFFFF", "#FF3333")
    turtle.setpos(-50,220)
    turtle.write("Visualization of columns:", True, align="right", font = ("Arial", 16, "bold"))
    turtle.color("#999999", "#FF3333")
    turtle.setpos(-60,195)
    turtle.write("circles = prime numbers", True, align="right", font = ("Arial", 12, "bold"))
    turtle.setpos(280,-265)
    turtle.write("@PavelVavruska 2012", True, align="right", font = ("Arial", 12, "bold"))
